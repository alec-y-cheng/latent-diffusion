...
IMG_H, IMG_W = 504, 504
X_CH = 8
Y_CH = 2  # ch0: mag_U (mean wind speed), ch1: k (turbulent kinetic energy)
...
def process_csv(file_path, xx_dense, yy_dense):
    ...
    try:
        req_cols = ['X', 'Y', 'Z_relative', 'SDF', 'Bldg_height', 'U_over_Uref', 'dir_sin', 'dir_cos', 'mag_U', 'k']
        ...
        y_out = np.zeros((2, IMG_H, IMG_W), dtype=np.float32)  # ch0: mag_U, ch1: k
        ...
        # Targets: mag_U (ch0) and k/TKE (ch1)
        ...
        # mag_U is physically non-negative; k is strictly non-negative.
...
def main():
    ...
    parser.add_argument("--output", type=str, default="new_dataset_uk.npz", help="Output file")
